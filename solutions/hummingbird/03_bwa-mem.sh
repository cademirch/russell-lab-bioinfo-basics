...
#SBATCH --output=/hb/home/cmirchan/bioinfo-basics/slurm/out/bwa_mapping_%A_%a.out
#SBATCH --error=/hb/home/cmirchan/bioinfo-basics/slurm/err/bwa_mapping_%A_%a.err
...
data_path="/hb/home/cmirchan/bioinfo-basics/fly-data"
output_path="/hb/home/cmirchan/bioinfo-basics/output"
reference_genome="/hb/home/cmirchan/bioinfo-basics/output/genome/combined.fna.gz"  # Replace with actual reference genome path
mkdir -p $output_path
